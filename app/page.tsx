...
import { categories, categoryArt, products } from "@/data/products";
  ...
  return (
    <div className="pb-24 lg:pb-0">
      ...
      <section className="hero-gradient relative overflow-hidden rounded-b-[2rem] text-white sm:rounded-b-[3rem]">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-6 py-14 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-8 lg:py-14">
          <div className="min-w-0">
            ...
            {/* Only the headline sits beside the corner visual — everything below it
                clears the visual and spans the full width. */}
            <h1 className="mt-5 pr-24 text-3xl font-bold leading-[1.05] tracking-tight sm:pr-48 sm:text-5xl lg:pr-0 lg:text-6xl">
              Your pharmacy,
              <br />
          ...
          {/* Visual — uniformly scaled down and pinned into the hero's free top-right
              corner on mobile; full size in the grid from lg up. Contents unchanged. */}
          <div className="absolute right-4 top-16 h-24 w-24 overflow-hidden sm:right-6 sm:h-44 sm:w-44 lg:static lg:h-auto lg:w-full lg:max-w-md lg:justify-self-end lg:overflow-visible">
            <div className="relative aspect-square w-[448px] origin-top-left scale-[0.2143] sm:scale-[0.393] lg:w-full lg:origin-center lg:scale-100">
              <div className="absolute inset-6 flex flex-col items-center justify-center gap-3 rounded-[2.5rem] bg-white/5 ring-1 ring-white/10 backdrop-blur-sm">
              <span className="grid h-14 w-14 place-items-center rounded-full bg-white/15 text-white/70 ring-1 ring-white/20">
                <Cross size={26} />
              </span>
              <p className="text-xl font-bold tracking-tight text-white/50">MedWell</p>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16 sm:pb-20">
        <div className="hero-gradient relative overflow-hidden rounded-3xl px-7 py-12 text-center text-white sm:px-12 sm:py-16">
          <Image
